...
namespace BARNEY_NS {
  namespace anari {
    ...
    template <int TYPE>
    inline void convert_to_float4(const void *_in,
                                  std::vector<::anari::math::float4> &out)
    {
    ...
    inline bool convert_to_float4(const helium::IntrusivePtr<helium::Array> &input,
    ...
    inline bool convert_to_rgba8(const helium::IntrusivePtr<helium::Array> &input,
    ...
    static
    BNTexture2D makeBarneyTexture2D(BNContext context, int slot,
                                    const helium::IntrusivePtr<helium::Array> &input,
