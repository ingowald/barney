  ...
  namespace render {
    namespace device {
      ...
      struct GeometryAttributes {
        ...
        inline __device__ GeometryAttribute &operator[](int i) { return attribute[i]; }
        inline __device__ const GeometryAttribute &operator[](int i) const { return attribute[i]; }
