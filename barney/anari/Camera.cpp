...
namespace BARNEY_NS {
  namespace anari {
    ...
    void Camera::applyBaseCameraParameters()
    {
      bnSet4f(m_barneyCamera, "imageRegion",
              m_imageRegion.x, m_imageRegion.y,
              m_imageRegion.z, m_imageRegion.w);
...
BARNEY_ANARI_TYPEFOR_DEFINITION(BARNEY_NS::anari::Camera *);
