...
#define DEFINE_BARNEY_ARRAY_IMPL(DIM)                                   \
    Array##DIM::Array##DIM(BarneyGlobalState *state,                    \
...
BARNEY_ANARI_TYPEFOR_DEFINITION(BARNEY_NS::anari::Array1D *);
BARNEY_ANARI_TYPEFOR_DEFINITION(BARNEY_NS::anari::Array2D *);
BARNEY_ANARI_TYPEFOR_DEFINITION(BARNEY_NS::anari::Array3D *);
